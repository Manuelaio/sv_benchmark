...
The outputs of each caller was merged in a single file both for [all SVs](https://github.com/Manuelaio/sv_benchmark/blob/main/benchmark/all_result.txt) both for [filterd SVs](https://github.com/Manuelaio/sv_benchmark/tree/main/benchmark) by segmental duplication and using `make_plot.R ` the precion-recall results could be plotted in stored in pdf file. 
